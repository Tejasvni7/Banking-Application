...
public class constants {
    ...
    public static final String NO_ACCOUNT_FOUND =
            "Unable to find account matching given sort code and account number";
    public static final String INVALID_SEARCH_CRITERIA =
            "The sort code or account number did not match the expected format";
    ...
    public static final String CREATE_ACCOUNT_FAILED =
            "Error occured during creating new account";
}
