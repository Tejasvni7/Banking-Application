package com.springboot.banking.integration;

import com.springboot.banking.controllers.AccountRestController;
...
class CheckBalanceIntegrationTest {
    ...
    void givenAccountDetails_whenCheckingBalance_thenVerifyAccountCorrect() {
        ...
        assertThat(account.getOwnerName()).isEqualTo("Tejaswini Royyapalla");
